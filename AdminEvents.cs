    ...
    public partial class AdminEvents : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                /*Validate if Start Time and End Time are in valid TimeSpan format*/
                ...
                /*Creates a new Events object with the provided details*/
                ...
                string result = Admin.addEvents(newEvent, userID);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string result = Admin.updateEvent(updatedEvent);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string result = Admin.deleteEvent(eventID);
